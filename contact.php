        ...
        <div class="container">
            ...
            <div class="row">
                <div class="d-none d-sm-block mb-5 pb-4">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.977744220091!2d106.72545921476879!3d-6.133692495558896!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwMDgnMDEuMyJTIDEwNsKwNDMnMzkuNSJF!5e0!3m2!1sen!2sid!4v1612845006225!5m2!1sen!2sid" width="1200" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
                <div class="col-12">
                    <h2 class="contact-title">Get in Touch</h2>
                </div>
                <div class="col-lg-8">
                    <form class="form-contact contact_form" action="comment.php" method="post">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <textarea class="form-control w-100" name="pesan" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Message'" placeholder=" message"></textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input class="form-control valid" name="nama" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" placeholder="Enter your name">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3>Ruko Fantasi Taman Palem (Ruko Seribu) Blok Z2 No 30</h3>
                            <p>Kel. Cengkareng Barat
                                <br>
                                Kec. Cengkareng
                            </p>
                        </div>
                    ...
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3>+62 812 8888 9662</h3>
                        </div>
                    </div>
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-email"></i></span>
                        <div class="media-body">
                            <h3>indopelumas@gmail.com</h3>
                            <h3>sales@indopelumas.com</h3>
                        </div>
                    </div>
                </div>
            </div>
